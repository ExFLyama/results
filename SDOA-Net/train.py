...
if __name__ == '__main__':
    ...
    parser.add_argument('--gaussian_std', type=float, default=40, help='Gaussian std for reference spectrum')
    parser.add_argument('--batch_size', type=int, default=64, help='the size of batch')

    # module parameters (aligned with main.py)
    ...
    parser.add_argument('--n_epochs', type=int, default=300, help='number of epochs used to train the module')  # 300
    ...
    parser.add_argument('--train_num', type=int, default=1, help='number of curriculum training rounds')
    ...
    for idx in range(args.train_num):
        for train_type in range(7):
            ...
            if args.net_type == 0:
                ...
                torch.save(net, ('deepfreq_layer%d.pkl' % args.n_layers))
